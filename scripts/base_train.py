...
from berserker.configs import GPT, GPTConfig, Linear
from berserker.dataloader import tokenizing_distributed_data_loader_bos_bestfit, tokenizing_distributed_data_loader_with_state_bos_bestfit
from berserker.common import compute_init, compute_cleanup, print0, DummyWandb, print_banner, get_base_dir, autodetect_device_type, get_peak_flops, COMPUTE_DTYPE, COMPUTE_DTYPE_REASON, is_ddp_initialized
from berserker.tokenizer import get_tokenizer, get_token_bytes
from berserker.checkpoint_manager import save_checkpoint, load_checkpoint
from berserker.loss_eval import evaluate_bpb
from berserker.engine import Engine
from berserker.flash_attention import HAS_FA3
...
wandb_run = DummyWandb() if use_dummy_wandb else wandb.init(project="berserker", name=args.run, config=user_config)

# Flash Attention status
from berserker.flash_attention import USE_FA3
using_fa3 = USE_FA3
if using_fa3:
...
if args.fp8:
    if device_type != "cuda":
        ...
        from berserker.fp8 import Float8LinearConfig, convert_to_float8_training
...
if batch_ratio != 1.0:
    # SGD: linear scaling with batch size is standard (not used in berserker)
