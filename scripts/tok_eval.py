...
from berserker.tokenizer import get_tokenizer, RustBPETokenizer
from berserker.dataset import parquets_iter_batched
...
all_text = [
    ...
    ("fineweb-edu-train", train_text),
]
if val_text:
    all_text.append(("fineweb-edu-val", val_text))
