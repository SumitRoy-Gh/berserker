...
Examples:
    ...
    # Evaluate a berserker model (e.g. d24) using 8 GPUs
...
from berserker.common import compute_init, compute_cleanup, print0, get_base_dir, autodetect_device_type, download_file_with_lock
from berserker.tokenizer import get_token_bytes
from berserker.checkpoint_manager import load_model
from berserker.core_eval import evaluate_task
from berserker.dataloader import tokenizing_distributed_data_loader_bos_bestfit
...
def main():
    ...
    parser.add_argument('--model-tag', type=str, default=None, help='berserker model tag to identify the checkpoint directory')
