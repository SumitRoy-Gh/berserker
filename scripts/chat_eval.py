...
code lives in berserker directory and is imported from here.
...
from berserker.common import compute_init, compute_cleanup, get_dist_info, print0, autodetect_device_type
