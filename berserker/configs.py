...
from berserker.common import get_dist_info, print0, COMPUTE_DTYPE
from berserker.optim import MuonAdamW
...
class GPTConfig:
    ...
    #Ratio: 4:1 (Every group of 4 Query heads shares 1 KV head pair).
    n_embd: int = 512
